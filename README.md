...
b'_5#y2L"F4Q8z\n\xec]/'
```
Which will print a byte string, copy that and replace _<A_BYTE_STRING>_ with it. The *TIME_STAMP* is an integer which is a Unix time stamp and can be found [here](https://www.unixtimestamp.com/), just copy the current time stamp, and paste it.
